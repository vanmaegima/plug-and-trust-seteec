...
IF(WithRTOS_FreeRTOS)
    ...
    SET(
        _FLAGS_L_LD
        " \
    -T${SIMW_TOP_DIR}/ext/mcu-sdk/devices/MIMXRT1062/gcc/WithRTOS_FreeRTOS/MIMXRT1062xxxxx_flexspi_nor.ld \
    -static "
    )
ENDIF()
IF(WithRTOS_Default)
    ...
    SET(
        _FLAGS_L_LD
        " \
    -T${SIMW_TOP_DIR}/ext/mcu-sdk/devices/MIMXRT1062/gcc/WithRTOS_Default/MIMXRT1062xxxxx_flexspi_nor.ld \
    -static "
    )
ENDIF()
