...
doApplet_SE051_UWB_ON="-DApplet=SE051_UWB" #SE051UWB (Similar to SE05x)
doApplet_AUTH_ON="-DApplet=AUTH" #AUTH
...
doSMCOM_JRCP_V1_AM_ON="-DSMCOM=JRCP_V1_AM" #JRCP_V1 extended with Access manager features
...
doSBL_None_ON="-DSBL=None" #Not SBL bootable
doSBL_SBL_LPC55S_ON="-DSBL=SBL_LPC55S" #SE050 based LPC55S SBL bootable
