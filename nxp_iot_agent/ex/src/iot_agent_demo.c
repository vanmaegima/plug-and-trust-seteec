...
#if	((AX_EMBEDDED && defined(USE_RTOS) && USE_RTOS == 1) || (SSS_HAVE_OPENSSL)) && (IOT_AGENT_COS_OVER_RTP_ENABLE == 1)
...
#if (AX_EMBEDDED && defined(USE_RTOS) && USE_RTOS == 1) || (SSS_HAVE_OPENSSL)
